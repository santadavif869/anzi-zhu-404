    ...
    <React.StrictMode>
      <WidgetContainer>
        ...
        >
          ...
          <button onClick={()=>{window.open('https://login.1ho.online')}} type="submit" className="flex w-full justify-center rounded-md bg-red-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-red-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-400" 
              >立即升级</button>
              <button onClick={()=>{window.open('https://login.1ho.online')}} type="submit" className="mt-2 flex w-full justify-center rounded-md bg-neutral-700 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-neutral-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-400" 
              >会员登录</button>
          </div>
        </div>
        </div>
